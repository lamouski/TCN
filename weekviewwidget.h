...
protected slots:
    ...
    void changeField(int day, const QModelIndex &index, ProcessingFlag flag);
...
private:
    ...
    QAction* m_action_change_field = nullptr;
    QAction* m_action_change_field_abo_all = nullptr;
